...
fun main() {
    ...
    repeat(testCases) {
        ...
        for (city in 0 until numberOfCity) {
            ...
            val numberOfNeighbors = reader.readLine().toInt() // Read the number of neighbors for the current city.
            repeat(numberOfNeighbors) {
        ...
        val queries = reader.readLine().toInt() // Read numbers of queries to find path.
